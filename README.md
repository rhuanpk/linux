...
- `notes.md`: é um *markdown* com mais de *5k* linhas com praticamente tudo que já anotei pelo decorrer do caminho. Da mesma forma que os *scripts*, muitas vezes precisei descobrir algum novo comando no qual posteriormente queria relembra-lo, porém, de forma simple e rápida. Essa nova *flag*, comando, ou até mesmo, forma de utiliar, foi tão legal que precisei registrar... Não precisei novamente sair buscando na internt, um simples `ctrl+f` nas anotações e pronto.
