...
PATHWAY_SWAPPY="$HOME/.config/swappy/config"
...
PATHWAY_VSCODE_SETTINGS="$HOME/.config/Code/User/settings.json"
PATHWAY_VSCODE_KEYBINDINGS="$HOME/.config/Code/User/keybindings.json"
...
cp-backup "$PATHWAY_QT5" "${ARRAY_PATHWAY_BACKUP['qt5']}"
cp-backup "$PATHWAY_QT6" "${ARRAY_PATHWAY_BACKUP['qt6']}"
...
cp-backup "$PATHWAY_THUNAR" "${ARRAY_PATHWAY_BACKUP['thunar']}"
